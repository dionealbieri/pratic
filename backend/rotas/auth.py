...
def get_me(current_user = Depends(get_current_user)):
    ...
    try:
        ...
        if row:
            ...
            defaults = {
                "gestor":   "dashboard,producao,premiacao,colaboradores,maquinas,pedidos,estoque,epi,saldo-demanda,consumo-medio,gerencial,comunicacao,graficos,relatorios,configuracoes,backup,permissoes,empresa,mobile,estoque_mobile",
