...
from rotas import auth, colaboradores, maquinas, producao, premiacao, configuracoes, relatorios, estoque, pedidos, epi, comunicacao, gerencial, pintura
...
app.include_router(pintura.router,        prefix="/api/pintura",        tags=["Pintura"],       dependencies=[Depends(get_current_user)])
